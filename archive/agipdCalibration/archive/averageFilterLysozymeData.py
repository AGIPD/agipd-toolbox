...
dset_badPixelMask = saveFile_badPixelMask.create_dataset("badPixelMask", shape=(dset_analogCorrected.shape[0], 128, 512), dtype='float32')
...
for i in np.arange(dset_analogCorrected.shape[0]):
    ...
    dset_badPixelMask[i, ...] = badPixelMask
